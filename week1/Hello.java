 ...
 */
 ...
 System.out.println("A \"quoted\" string \n\n'much' better if you learn\n\nthe rules of \"escape sequences.\"\n\nAlso, \"\" represents an empty\n\nString. Don't forget: use \\\" instead of \" !\n\n'' is not the same as \"");
...
One is what we see when we're typing our program. The other is what appears on the "console." */
      // This prints a string literal to the console.
      System.out.println("Hello, World!");

      // This prints a string containing a double quote character.
